...
/**
 * Get file content for Resources/Public/Icons/Extension.svg
 */
class ExtensionIconBuilder implements BuilderInterface
{
    public function build(Graph $graph, string $extPath): void
    {
        $extIconPath = $extPath . 'Resources/Public/Icons/';
