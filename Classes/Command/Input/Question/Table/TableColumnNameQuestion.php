...
readonly class TableColumnNameQuestion extends AbstractAttributeQuestion
{
    public const ARGUMENT_NAME = 'columnName';

    public const INFORMATION_CLASS = TableColumnInformation::class;

    public const QUESTION = [
        'Enter column name we should create for you',
    ];
    ...
    public function ask(CommandContext $commandContext, InformationInterface $information, ?string $default = null): void
    {
        ...
        $information->setColumnName($this->askQuestion(
